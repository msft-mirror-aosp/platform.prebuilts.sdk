...
# pom2mk -static-deps -sdk-version current '-rewrite=^android.arch.persistence.room:common$=android-arch-room-common' '-rewrite=^support-compat$=android-support-compat' '-rewrite=^preference-v14$=android-support-v14-preference' '-rewrite=^android.arch.lifecycle:livedata$=android-arch-lifecycle-livedata' '-rewrite=^android.arch.persistence.room:runtime$=android-arch-room-runtime' '-rewrite=^multidex-instrumentation$=android-support-multidex-instrumentation' '-rewrite=^android.arch.core:common$=android-arch-core-common' '-rewrite=^android.arch.lifecycle:common-java8$=android-arch-lifecycle-common-java8' '-rewrite=^android.arch.persistence:db$=android-arch-persistence-db' '-rewrite=^leanback-v17$=android-support-v17-leanback' '-rewrite=^recommendation$=android-support-recommendation' '-rewrite=^palette-v7$=android-support-v7-palette' '-rewrite=^support-core-ui$=android-support-core-ui' '-rewrite=^android.arch.lifecycle:livedata-core$=android-arch-lifecycle-livedata-core' '-rewrite=^android.arch.persistence.room:migration$=android-arch-room-migration' '-rewrite=^support-v4$=android-support-v4' '-rewrite=^constraint-layout-solver$=android-support-constraint-layout-solver' '-rewrite=^support-dynamic-animation$=android-support-dynamic-animation' '-rewrite=^support-annotations$=android-support-annotations' '-rewrite=^support-emoji-appcompat$=android-support-emoji-appcompat' '-rewrite=^percent$=android-support-percent' '-rewrite=^preference-leanback-v17$=android-support-v17-preference-leanback' '-rewrite=^android.arch.lifecycle:runtime$=android-arch-lifecycle-runtime' '-rewrite=^android.arch.persistence:db-framework$=android-arch-persistence-db-framework' '-rewrite=^gridlayout-v7$=android-support-v7-gridlayout' '-rewrite=^preference-v7$=android-support-v7-preference' '-rewrite=^support-core-utils$=android-support-core-utils' '-rewrite=^android.arch.paging:runtime$=android-arch-paging-runtime' '-rewrite=^slices-view$=android-slices-view' '-rewrite=^android.arch.lifecycle:common$=android-arch-lifecycle-common' '-rewrite=^exifinterface$=android-support-exifinterface' '-rewrite=^constraint-layout$=android-support-constraint-layout' '-rewrite=^support-emoji$=android-support-emoji' '-rewrite=^slices-core$=android-slices-core' '-rewrite=^slices-builders$=android-slices-builders' '-rewrite=^appcompat-v7$=android-support-v7-appcompat' '-rewrite=^wear$=android-support-wear' '-rewrite=^support-tv-provider$=android-support-tv-provider' '-rewrite=^android.arch.persistence.room:testing$=android-arch-room-testing' '-rewrite=^recyclerview-v7$=android-support-v7-recyclerview' '-rewrite=^support-fragment$=android-support-fragment' '-rewrite=^android.arch.lifecycle:extensions$=android-arch-lifecycle-extensions' '-rewrite=^android.arch.lifecycle:viewmodel$=android-arch-lifecycle-viewmodel' '-rewrite=^transition$=android-support-transition' '-rewrite=^mediarouter-v7$=android-support-v7-mediarouter' '-rewrite=^animated-vector-drawable$=android-support-animatedvectordrawable' '-rewrite=^support-emoji-bundled$=android-support-emoji-bundled' '-rewrite=^android.arch.core:runtime$=android-arch-core-runtime' '-rewrite=^android.arch.paging:common$=android-arch-paging-common' '-rewrite=^support-media-compat$=android-support-media-compat' '-rewrite=^customtabs$=android-support-customtabs' '-rewrite=^support-v13$=android-support-v13' '-rewrite=^cardview-v7$=android-support-v7-cardview' '-rewrite=^support-vector-drawable$=android-support-vectordrawable' '-rewrite=^multidex$=android-support-multidex' .
